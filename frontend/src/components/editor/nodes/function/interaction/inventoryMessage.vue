...
const defaultObjData =  { //This is the data that this component contributes. Any existing properties within the functional node data will be replaced
    display_type:"Inventory Message",
    function_name: 'inventoryMessage',
    function_params: [],
  }
...
<template>
    ...
    <FunctionBase
        ...
        <Textboxes handleOutput=false handleInput=false :id="id" startingQuantity=1 allowButtons=false title="Inventory Message"></Textboxes>
        </HContainer>
