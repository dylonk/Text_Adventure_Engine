...
const defaultObjData =  { //This is the data that this component contributes. Any existing properties within the functional node data will be replaced
    display_type:"Show Inventory Messages",
    function_name: 'showInventoryMessages',
    function_params: [],
  }
  console.log("inventoryMessage.vue: ReferenceID is = " + props.id)
...
<template>
    ...
    <FunctionBase
        ...
        <Textboxes handleOutput=true handleInput=true :id="id" startingQuantity=1 allowButtons=false title="Show Inventory Messages"></Textboxes>
        </HContainer>
